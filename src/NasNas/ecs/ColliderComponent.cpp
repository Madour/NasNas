...
ColliderComponent::ColliderComponent(BaseEntity* entity, Collision* collision, bool is_dynamic, sf::Vector2f pos_offset) :
...
ColliderComponent(entity, collision, false, pos_offset)
{}
